...
@section('contents')
    ...
    <form enctype="multipart/form-data" class="form-horizontal" action="{{ route('admin.post.store') }}" method="post">
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" name="title" id="title" class="form-control" placeholder="Type post title">
            ...
            <div class="card">
                <div class="header">
                  ...
                  <div class="body" >
                      ...
                      <a href="{{route('admin.post.index')}}" class="btn btn-primary m-t-15 waves-effect">Cancel</a>
